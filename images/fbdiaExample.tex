...
% \draw[->, thick] (0,0) -- (0,1) node[above] {$y$};
  ...
  % Forces
  \draw[->, thick, blue] (0,0) -- (0,-1.5) node[midway, left] {$T_B = 1962\,\text{N}$};
  \draw[->, thick, red] (0,0) -- (-1.81,0.85) node[midway, below left] {$T_{A1}$};
  \draw[->, thick, red] (0,0) -- (1.81,0.85) node[midway, below right] {$T_{A2}$};
