...
1.  Calculate the final volume when $1 \, \text{m}^3$ of gas at a pressure of\
    $120 \, \text{kN/m}^2$ is compressed to a pressure of $960 \, \text{kN/m}^2$.

2.  Calculate the initial volume of a gas at a pressure of $1.05 \, \text{bar}$\
    that will occupy a volume of $5.6 \, \text{m}^3$ when it is compressed to a\
    pressure of $42 \, \text{bar}$.
