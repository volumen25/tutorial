...
print("="*85)
print("Part             Area (mm²)     y (mm)       A·y               A·y²        Iown")
print("-"*85)
...
for name, A, y, Iown in parts:
    ...
    print(f"{name}  {A:8.0f}   {y:8.1f}   {Ay:12.0f}   {Ay2:16.0f}   {Iown:12.0f}")
...
print("-"*85)
print(f"{'TOTAL':<14}  {total_A:8.0f}   {'':>8}   {sum_Ay:10.0f}   {sum_Ay2:18.0f}   {sum_Iown:10.0f}")
print("="*85)
print()
print("FINAL RESULTS")
print("═"*60)
...
print(f"I about bottom face       : {I_bottom/1e6:5.1f} × 10⁶ mm⁴ (reference only)")
print(f"I about neutral axis      : {I_na/1e6:4.1f} × 10⁶ mm⁴ (used for design)")
